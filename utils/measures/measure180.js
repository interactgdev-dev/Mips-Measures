...
const measure180RheumatoidArthritisGlucocorticoidManagement = async (collection, records) => {
  ...
  for (const record of records) {
    ...
    state.hasAdditionalEncounterIndicator = state.hasAdditionalEncounterIndicator || hasCode(record, "M1376");
  }
  ...
  for (const record of records) {
    ...
    updatesByRecord.set(record, {
      ICD180: ct1DenominatorMet ? 1 : 0,
      CPT180: ct1DenominatorMet ? 1 : 0,
      M180: ct1DenominatorMet ? 1 : 0,
      N180_MET: 0,
      N180_EXCEPTION: 0,
      N180_NOT_MET: 0,
      QDC180: "",
